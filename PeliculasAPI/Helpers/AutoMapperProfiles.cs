...
namespace PeliculasAPI.Helpers
{
    public class AutoMapperProfiles: Profile
    {
        ...
        {
            //Fuente, destino 
            //de donde voy a mapear hacia donde
            ...
            //Se mapea para leer
            //de actor a actor dto... para no mostrar todas las propiedades
            CreateMap<Actor, ActorDTO>().ReverseMap(); //El reverse se usa para los dos lados
            //desde actorcreacion a actor
